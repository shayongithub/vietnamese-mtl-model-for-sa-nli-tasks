...
def main(model_args, data_args, training_args, args):
    ...
    # ViNLI dataset
    raw_datasets = load_from_disk('./merged_uit_sa_ds')
    ...
    model = AutoModelForSequenceClassification.from_pretrained(
        model_args.encoder_name_or_path, num_labels=2,
    )
    ...
    if training_args.do_eval:
        ...
        trainer.log_metrics('eval for sa', metrics)
        print('--------------------------------------------')

        trainer.save_metrics('eval_sa', metrics)
